...
public class PatchFactory
{
	...
	static {
		...
		PATCH_QUERY = new SelectBuilder().addVar(G).addVar(S).addVar(P).addVar(O)
	 ...
	 * @param orig the Dataset that contains the original data.
	 * @param revised the Dataset that contains the revised data.
	 * @return the Patch for the difference.
	 */
	 ...
	 * @param orig the Model that contains the original data.
	 * @param revised the Model that contains the revised data.
	 * @return the Patch for the difference.
	 */
	 ...
	 * @param orig the Graph that contains the original data.
	 * @param revised the Graph that contains the revised data.
	 * @return the Patch for the difference.
	 */
	...
	{
		return WrappedIterator.create(conn.query(PATCH_QUERY.build()).execSelect())
				.mapWith( TO_QUAD_FUNC ).toList();
	}
